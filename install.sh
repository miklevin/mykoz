...
result="`eval ${WINUSEr}`"
lxc config device add jupyter repos disk source=${result}repos path=/home/ubuntu/repos
lxc config device add jupyter ssh disk source=${result}.ssh/ path=/home/ubuntu/.ssh
