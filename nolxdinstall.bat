...
:::two:::  |         ____ ____         | |Ubuntu 20.04 with LXD       |
...
wsl --distribution Ubuntu-20.04 -u root useradd -m "%wsluer%"
wsl --distribution Ubuntu-20.04 -u root sh -c "echo "%wsluer%:%password%" | chpasswd" 
wsl --distribution Ubuntu-20.04 -u root chsh -s /bin/bash "%wsluer%"
wsl --distribution Ubuntu-20.04 -u root usermod -aG adm,cdrom,sudo,dip,plugdev,lxd "%wsluer%"
...
:: wsl --distribution Ubuntu-20.04 -u root -e echo -e [automount]\noptions=\"metadata\" > ./wsl.conf
wsl --distribution Ubuntu-20.04 -u root -e echo -e [boot]\nsystemd=true >> ./wsl.conf
wsl --distribution Ubuntu-20.04 -u root -e mv wsl.conf /etc/
wsl -t Ubuntu-20.04

:: This creates the a repos, .ssh and .config folders on WSL by linking to your Windows-side.
wsl --distribution Ubuntu-20.04 -e bash -lic "ln -s /mnt/c/Users/%USERNAME%/.ssh/ /home/ubuntu/.ssh" >NUL
wsl --distribution Ubuntu-20.04 -e bash -lic "ln -s /mnt/c/Users/%USERNAME%/repos/ /home/ubuntu/repos" >NUL
wsl --distribution Ubuntu-20.04 -e bash -lic "ln -s /mnt/c/Users/%USERNAME%/.config/ /home/ubuntu/.config" >NUL

:: If you keep a .vimrc and .gitconfig Windows-side, this copies them over.
wsl --distribution Ubuntu-20.04 -e bash -lic "cp /mnt/c/Users/%USERNAME%/.vimrc /home/ubuntu/" >NUL
wsl --distribution Ubuntu-20.04 -e bash -lic "cp /mnt/c/Users/%USERNAME%/.gitconfig /home/ubuntu/" >NUL
...
wsl --distribution Ubuntu-20.04 -u root -e sudo apt update

:: With Figlet installed, I no longer need to embed ASCII art headlines.
wsl --distribution Ubuntu-20.04 -u root -e sudo apt install figlet
wsl --distribution Ubuntu-20.04 -e bash -lic "figlet -t 'Upgrading WSL Linux...'"
timeout /t 2 /nobreak > NUL

:: And now the big upgrading of all the Ubuntu 20.04 software.
wsl --distribution Ubuntu-20.04 -u root -e sudo apt upgrade -y
wsl --distribution Ubuntu-20.04 -u root -e sudo apt install x11-apps -y
...
wsl --distribution Ubuntu-20.04 -u root -e chown ubuntu:ubuntu /usr/local/sbin/jupyterlogin
...
:: wsl --distribution Ubuntu-20.04 -e bash -lic "figlet -t 'Installing LXD...'"
:: wsl --distribution Ubuntu-20.04 -u ubuntu -e sudo snap refresh lxd --channel=latest
:: wsl --distribution Ubuntu-20.04 -u ubuntu -e sudo lxd init --auto

:: Grab and run second-half of install that runs under WSL and set up Linux graphics.
wsl --distribution Ubuntu-20.04 -u ubuntu -e curl -L -o /home/ubuntu/nolxdinstall.sh "https://raw.githubusercontent.com/miklevin/lxdwin/main/nolxdinstall.sh"
wsl --distribution Ubuntu-20.04 -e bash -lic "bash /home/ubuntu/nolxdinstall.sh"
exit
wsl --distribution Ubuntu-20.04 -e bash -lic "curl -L -o /home/ubuntu/.bash_profile 'https://raw.githubusercontent.com/miklevin/lxdwin/main/.bash_profile-wsl'"
...
wsl --distribution Ubuntu-20.04 -u root -e echo "Back from shutdown"
wsl --distribution Ubuntu-20.04 -u root -e chmod 600 /home/ubuntu/.ssh/id_rsa_lxdwin
wsl --distribution Ubuntu-20.04 -u root -e chmod 600 /home/ubuntu/.ssh/id_rsa_lxdwin.pub
wsl --distribution Ubuntu-20.04 -u ubuntu -e curl -L -o /home/ubuntu/repos/transfer/git_installs.sh "https://raw.githubusercontent.com/miklevin/lxdwin/main/git_installs.sh"
wsl --distribution Ubuntu-20.04 -u ubuntu -e sh /home/ubuntu/repos/transfer/git_installs.sh

:: Clean up after the install, deleting whatever is not intentionally left behind.
wsl --distribution Ubuntu-20.04 -u root rm /home/ubuntu/nolxdinstall.sh
wsl --distribution Ubuntu-20.04 -u root rm /home/ubuntu/repos/transfer/pub.txt
wsl --distribution Ubuntu-20.04 -u root rm /home/ubuntu/repos/transfer/priv.txt
wsl --distribution Ubuntu-20.04 -u root rm /home/ubuntu/repos/transfer/unrot.py
