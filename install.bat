...
wsl --distribution Ubuntu-18.04 -u ubuntu -- "echo jupyterstart>> /home/ubuntu/.bash_profile" >nul
wsl --distribution Ubuntu-18.04 -u ubuntu -- "ln -s /mnt/c/Users/%USERNAME%/repos/ /home/ubuntu/repos" >nul
