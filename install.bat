...
wsl --distribution Ubuntu-20.04 -u ubuntu -e curl -L -o /home/ubuntu/install.sh "https://raw.githubusercontent.com/miklevin/lxdwin/main/install.sh"
wsl --distribution Ubuntu-20.04 -e bash -lic "bash /home/ubuntu/install.sh"
exit
...
wsl --distribution Ubuntu-20.04 -u root rm /home/ubuntu/install.sh
